      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav">
              <li <?php if (Lib\App::getRouter()->getController() == 'produto') { ?>class="active"<?php } ?>><a href="<?= Lib\App::getRouter()->getUrl('produto') ?>">Produto</a></li>
              <li <?php if (Lib\App::getRouter()->getController() == 'pedidos') { ?>class="active"<?php } ?>><a href="<?= Lib\App::getRouter()->getUrl('pedido') ?>">Pedidos</a></li>
